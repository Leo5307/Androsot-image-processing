    ...
    def robot_pose_estimation(self):
        ...
        if(index != 999):#,3,5,7,9,counterclockwise
            ...
            if self.camera_setting == "left":
                ...
                self.degree_left = self.aruco_degree_list[index]
...
class Robot_Team():
    ...
    def get_information(self,needed_direction):
        ...
        return id_result,x_result,y_result,degree_result
...
if __name__ == '__main__':
    ...
    while True:
        ...
        # cap = cap1
            ...
            id_result,x_result,y_result,degree_result = blue_team.get_information(needed_direction=camera.index)
            ...
            cv2.putText(frame,'ids:'+ str(id_result) ,(0, 70), font, 1, (0, 255, 0), 2,cv2.LINE_AA)
            cv2.putText(frame,'coordinates:'+ str([x_result,y_result]) ,(0, 110), font, 1, (0, 255, 0), 2,cv2.LINE_AA)
            cv2.putText(frame,'deg_z:'+ str(degree_result) ,(0, 150), font, 1, (0, 255, 0), 2,cv2.LINE_AA)
